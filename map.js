export const map = [
    ...
    [1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1],
    [2, 2, 2, 1, 2, 2, 1, 1, 1, 1, 1, 1, 1, 1, 2, 2, 1, 2, 2, 2],
    [2, 2, 2, 1, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 1, 2, 2, 2],
    [2, 2, 2, 1, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 1, 2, 2, 2],
    [1, 2, 2, 1, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 1, 2, 2, 1],
        ...
        for (let i = 0; i < this.game.row; i++){
            for (let j = 0; j < this.game.col; j++){
                if (this.map[i][j]=== 1){                    
                    ...
                    ctx.drawImage(this.dot, this.game.tile_size * j, this.game.tile_size * i, this.game.tile_size, this.game.tile_size);
                }             
            }
        }
    }
